...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.ViewHolder>{
    ...
    public FollowerAdapter(Context context, ArrayList<BlockedUserData> userLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new FollowerAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_follower, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull @NotNull FollowerAdapter.ViewHolder holder, int position) {
        ...
        holder.follower.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.dialog.getWindow().setContentView(R.layout.custom_follower_dialog);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            follower = itemView.findViewById(R.id.btn_follower);
