...
public class MuteAdapter extends RecyclerView.Adapter<MuteAdapter.ViewHolder> {

    private Context context;
    private ArrayList<BlockedUserData> userLists;

    public MuteAdapter(Context context, ArrayList<BlockedUserData> userLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_mute, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull MuteAdapter.ViewHolder holder, int position) {
        ...
        holder.unblock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                holder.dialog.getWindow().setContentView(R.layout.custom_mute_dialog);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            unblock = itemView.findViewById(R.id.btn_unmute);
