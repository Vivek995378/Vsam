...
public class LikeAdapter extends RecyclerView.Adapter<LikeAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new LikeAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_like, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull LikeAdapter.ViewHolder holder, int position) {
