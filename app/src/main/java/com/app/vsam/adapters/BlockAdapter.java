...
public class BlockAdapter extends RecyclerView.Adapter<BlockAdapter.ViewHolder> {
    ...
    public BlockAdapter(Context context, ArrayList<BlockedUserData> userLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_block, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull BlockAdapter.ViewHolder holder, int position) {
        ...
        holder.unblock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                holder.dialog.getWindow().setContentView(R.layout.custom_block_dialog);
